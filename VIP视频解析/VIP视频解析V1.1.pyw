...
label3.grid(row=2)
site = [('线路一', 'https://jx.jsonplayer.com/player/'),
        ('线路二', 'https://jx.yparse.com/index.php'),
        ('线路三', 'http://jx.9jsp.com/'),
        ('线路四', 'https://bd.jx.cn/'),
        ('线路五', 'http://www.wmxz.wang/video.php/'),
        ('线路六', 'https://jx.m3u8.tv/jiexi/'),
        ('线路七', 'https://www.ckplayer.vip/jiexi/'),
        ('线路八', 'https://www.8090g.cn/jiexi/')]
...
site_radio_04 = tk.Radiobutton(window, text=site[3][0], variable=site_v, value=site[3][1])
site_radio_04.grid(row=2, column=4)
site_radio_05 = tk.Radiobutton(window, text=site[4][0], variable=site_v, value=site[4][1])
site_radio_05.grid(row=3, column=1)
site_radio_06 = tk.Radiobutton(window, text=site[5][0], variable=site_v, value=site[5][1])
site_radio_06.grid(row=3, column=2)
site_radio_07 = tk.Radiobutton(window, text=site[6][0], variable=site_v, value=site[6][1])
site_radio_07.grid(row=3, column=3)
site_radio_08 = tk.Radiobutton(window, text=site[7][0], variable=site_v, value=site[7][1])
site_radio_08.grid(row=3, column=4)
